...
Calculate the derivative of a function `f` with respect to 
	variable `x` using forward differentiation.
# Arguments
...
# TODO: Add Jacobian, Gradient, Hessian, etc. for multivariate functions
